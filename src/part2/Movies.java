...
public class Movies extends JFrame implements ActionListener
{
    ...
    /*
    This is the constructor of the class. It initializes the Movies object with the provided fta (FilmTheatreApp) and dbManager objects. 
    It retrieves movies from the database, initializes the buttons, labels, and icons for each movie, sets the layout manager, location and sizes, 
    adds components to the container, and configures the frame.
    */
    ...
    /*
    This method handles the action events generated by the buttons and sign-out button. It performs different actions based on the event source, 
    such as hiding the current frame and creating a new TimeAndPeople frame when a movie button is clicked, or disposing of the current frame and 
    making the FilmTheatreApp frame visible when the sign-out button is clicked.
    */
    @Override
    ...
    /*
    This method searches for a movie with the given title in the list of movies. 
    It returns the first movie found with a case-insensitive match. If no movie is found, it returns null.
    */
