...
public class RewardsVIPTicket extends Ticket
{
    ...
    /*
    This is the constructor of the class. It initializes a RewardsVIPTicket object with the provided numberOfPeople, 
    ...
    */
    public RewardsVIPTicket(int numberOfPeople, MovieType movieType, double discountRate)
    {
